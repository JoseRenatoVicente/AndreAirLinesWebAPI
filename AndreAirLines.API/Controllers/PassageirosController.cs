...
using AndreAirLines.Application;
...
namespace AndreAirLines.API.Controllers
{
    ...
    public class PassageirosController : ControllerBase
    {
        ...
        public PassageirosController(AndreAirLinesAPIContext context, ViaCepService viaCepService)
        {
            _context = context;
        ...
        public async Task<ActionResult<Passageiro>> GetPassageiro(string id)
        {
            var passageiro = await _context.Passageiro
                ...
                .Where(c => c.Cpf == id).FirstOrDefaultAsync();
        ...
        public async Task<ActionResult<Passageiro>> PostPassageiro(Passageiro passageiro)
        {
            ...
            //var endereco = await _viaCepService.ConsultarCEP(passageiro.Endereco.CEP);

            //if (endereco is not null) passageiro.Endereco = endereco;
